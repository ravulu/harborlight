...
export interface StateTax {
   ...
   *
   * All eight apply income limits that exempt many retirees outright — those
   * are not modelled, so this errs high for lower incomes.
   */
...
export const STATE_TAXES: StateTax[] = [
  ...
  { code: 'MN', name: 'Minnesota', single: { brackets: [{rate:5.35,from:0},{rate:6.8,from:33310},{rate:7.85,from:109430},{rate:9.85,from:203150}], standardDeduction: 15300 }, married: { brackets: [{rate:5.35,from:0},{rate:6.8,from:48700},{rate:7.85,from:193480},{rate:9.85,from:337930}], standardDeduction: 30600 }, taxesSocialSecurity: true },
  ...
  { code: 'MT', name: 'Montana', single: { brackets: [{rate:4.7,from:0},{rate:5.65,from:47500}], standardDeduction: 16100 }, married: { brackets: [{rate:4.7,from:0},{rate:5.65,from:95000}], standardDeduction: 32200 }, taxesSocialSecurity: true },
  ...
  { code: 'RI', name: 'Rhode Island', single: { brackets: [{rate:3.75,from:0},{rate:4.75,from:82050},{rate:5.99,from:186450}], standardDeduction: 11200 }, married: { brackets: [{rate:3.75,from:0},{rate:4.75,from:82050},{rate:5.99,from:186450}], standardDeduction: 22400 }, taxesSocialSecurity: true },
  ...
  { code: 'UT', name: 'Utah', single: { brackets: [{rate:4.5,from:0}], standardDeduction: 0 }, married: { brackets: [{rate:4.5,from:0}], standardDeduction: 0 }, taxesSocialSecurity: true },
  { code: 'VT', name: 'Vermont', single: { brackets: [{rate:3.35,from:0},{rate:6.6,from:49400},{rate:7.6,from:119700},{rate:8.75,from:249700}], standardDeduction: 7650 }, married: { brackets: [{rate:3.35,from:0},{rate:6.6,from:82500},{rate:7.6,from:199450},{rate:8.75,from:304000}], standardDeduction: 15300 }, taxesSocialSecurity: true },
